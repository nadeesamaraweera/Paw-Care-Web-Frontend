        ...
        >
            ...
            >
                <div className="flex justify-between items-center border-b pb-2">
                    <h2 className="text-lg font-bold text-[#071722]">Donation Form</h2>
                    <button
                        onClick={onClose}
                ...
                <div className="flex flex-col gap-3 mt-3">
                    <Input label="Donation ID:" name="id" type="text" optional={false} placeholder="D-0001" className="w-full h-8 text-sm" />
                    <Input label="Date:" name="date" type="date" optional={false} placeholder="" className="w-full h-8 text-sm" />
                    <Input type="text" name="name" label="Description:" optional={true} placeholder="Ex:Note" className="w-full h-8 text-sm" />
                    <Input type="text" name="donator" label="Donator:" optional={false} placeholder="Ex:John Doe" className="w-full h-8 text-sm" />
                    <Input type="text" name="receiver" label="Receiver:" optional={false} placeholder="Ex:John Doe" className="w-full h-8 text-sm" />
